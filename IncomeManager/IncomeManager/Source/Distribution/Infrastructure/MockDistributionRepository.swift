...
class MockDistributionRepository: DistributionRepository {
    func fetchDistributions(date: Date) -> [Distribution] {
        ...
        let distribution5 = Distribution(date: Date(), categoryType: CategoryType.SAVINGS, percentage: 10, spentValue: 0)
        let distribution6 = Distribution(date: Date(), categoryType: CategoryType.SAVINGS, percentage: 10, spentValue: 0)
        let distribution7 = Distribution(date: Date(), categoryType: CategoryType.SAVINGS, percentage: 10, spentValue: 0)
